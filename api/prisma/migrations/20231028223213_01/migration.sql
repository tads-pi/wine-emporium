...
-- AddForeignKey
ALTER TABLE `ProductStock` ADD CONSTRAINT `ProductStock_stockUnitId_fkey` FOREIGN KEY (`stockUnitId`) REFERENCES `StockUnit`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
