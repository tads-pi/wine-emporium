            ...
            <Box sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
                    ...
                    <Box sx={{ m: 2 }}>
                        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                            ...
                            <IconButton color="primary" aria-label="add to shopping cart" style={{position: 'relative', bottom: '5px'}}>
                                <AddShoppingCartIcon onClick={handleClickVariant('success')}>Show success snackbar</AddShoppingCartIcon>
                            </IconButton>
                        </div>
